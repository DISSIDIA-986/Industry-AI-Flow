...
from backend.services.llm_integration.types import DispatchRequest, LLMUsage, RouteMode
...
class TestLLMDispatchIntegration:
    ...
    def mock_clients(self):
        ...
        with patch(
            ...
            "backend.services.llm_integration.dispatch_service.OpenAIClient"
        ) as mock_openai:
            # EN
            local_instance = Mock()
            ...
            yield {"llama": mock_llama, "zhipu": mock_zhipu, "openai": mock_openai}
    ...
    def test_redaction_before_cloud_call(self, service, mock_clients):
        ...
        # EN,EN
        cloud_instance = (
            mock_clients["zhipu"].return_value or mock_clients["openai"].return_value
        )
    ...
    def test_latency_tracking(self, service, mock_clients):
        ...
        request = DispatchRequest(
            tenant_id="test_tenant", question="Test", route_mode=RouteMode.LOCAL_ONLY
        )
    ...
    def test_route_modes_integration(
        self, service, mock_clients, route_mode, expected_provider
    ):
        """EN"""
        request = DispatchRequest(
            tenant_id="test_tenant", question="Test", route_mode=route_mode
        )
