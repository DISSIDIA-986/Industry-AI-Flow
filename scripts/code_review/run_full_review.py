...
class CodeReviewRunner:
    ...
    def phase1_document_scan(self) -> Dict[str, Any]:
        ...
        results = {"total": len(docs_to_check), "exists": 0, "missing": [], "found": []}
    ...
    def phase1_code_structure_review(self) -> Dict[str, Any]:
        ...
        results = {"directories": [], "modules": [], "issues": [], "score": 0}
        ...
        for dir_name in key_dirs:
            ...
            if full_path.exists() and full_path.is_dir():
                ...
                results["directories"].append(
                    {"path": dir_path, "file_count": len(py_files)}
                )
        ...
        for module_path in key_modules:
            ...
            try:
                with open(full_path, "r", encoding="utf-8") as f:
                    ...
                    print(
                        f"     - Functions: {len(functions) if 'functions' in locals() else 'N/A'}"
                    )
    ...
    def phase1_dependency_check(self) -> Dict[str, Any]:
            ...
            if full_path.exists():
                ...
                with open(full_path, "r") as f:
                    ...
                    results["requirements_files"].append(
                        {"path": req_file, "dependency_count": len(deps)}
                    )
        ...
        # 检查配置文件
        config_files = ["backend/config.py", ".env.example", ".gitignore"]
    ...
    def phase2_architecture_review(self) -> Dict[str, Any]:
        ...
        results = {"layers": {}, "patterns": [], "issues": [], "score": 0}
    ...
    def phase2_code_quality_review(self) -> Dict[str, Any]:
        ...
        results = {"pylint": None, "mypy": None, "test_coverage": None, "score": 0}
        ...
        for tool in tools:
            rc, stdout, stderr = self.run_command(
                [tool, "--version"], cwd=self.backend_dir
            )
            if rc == 0:
    ...
    def phase2_security_review(self) -> Dict[str, Any]:
        ...
        results = {"auth": {}, "security_checks": [], "issues": [], "score": 0}
    ...
    def run_all_phases(self):
        ...
        self.results["phase1_quick_diagnosis"][
            "document_scan"
        ] = self.phase1_document_scan()
        self.results["phase1_quick_diagnosis"][
            "code_structure"
        ] = self.phase1_code_structure_review()
        self.results["phase1_quick_diagnosis"][
            "ai_ml_modules"
        ] = self.phase1_ai_ml_modules_review()
        self.results["phase1_quick_diagnosis"][
            "key_code_review"
        ] = self.phase1_key_code_review()
        self.results["phase1_quick_diagnosis"][
            "dependency_check"
        ] = self.phase1_dependency_check()
        ...
        self.results["phase2_deep_review"][
            "architecture"
        ] = self.phase2_architecture_review()
        self.results["phase2_deep_review"][
            "ai_ml_engineering"
        ] = self.phase2_ai_ml_engineering_review()
        self.results["phase2_deep_review"][
            "code_quality"
        ] = self.phase2_code_quality_review()
    ...
    def save_results(self):
        """保存结果"""
        default_output = (
            self.project_root / "temp/reports/code_review/CODE_REVIEW_RESULTS.json"
        )
