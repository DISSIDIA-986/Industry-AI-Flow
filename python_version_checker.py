...
def run_with_version_check(func: Callable, *args, **kwargs) -> Any:
    ...
    try:
        ...
        print(f"{e}")
        print(f"\n💡 解决方案:")
        print(f"1. 确保安装了Python {REQUIRED_PYTHON_VERSION[0]}.{REQUIRED_PYTHON_VERSION[1]}")
...
def create_version_test_report() -> dict:
    ...
    report = {
        ...
        'python_version_ok': (sys.version_info.major, sys.version_info.minor) == REQUIRED_PYTHON_VERSION,
        'dependencies': {},
